...
Now you will have to navigate to your computer usarname folder, and place the file named .my_functions.sh there
Then, in the same directory, your computer username folder, edit the .bashrc file with your text editor and type in the following "source ~/.my_functions.sh". If the file
...
### Important Note
```bash
1. Please read the comments in both delete.py and .my_functions files to set the scripts up correctly
2. The last line of the function create in the .my_functions file ("subl $1") is a custom alias that I have created by typing 'alias subl="/C/Program\ Files/Sublime\ Text\ 3/sublime_text.exe"'
